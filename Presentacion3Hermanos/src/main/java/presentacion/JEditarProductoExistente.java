...
public class JEditarProductoExistente extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JEditarProductoExistente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JEditarProductoExistente dialog = new JEditarProductoExistente(new javax.swing.JFrame(), true);
